...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "The official universe of Mabel Quill — bestselling author of dark romance, fantasy romance, and mafia romance novels. Enter the world." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Mabel Quill Hub — Romance & Fantasy Author" },
      { name: "twitter:description", content: "The official universe of Mabel Quill — bestselling author of dark romance, fantasy romance, and mafia romance novels. Enter the world." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/7b862e4e-6c89-4909-a319-d9f8537952bf/id-preview-102fa5b4--979d47f9-4276-487c-9621-67fc948183b1.lovable.app-1778719327051.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/7b862e4e-6c89-4909-a319-d9f8537952bf/id-preview-102fa5b4--979d47f9-4276-487c-9621-67fc948183b1.lovable.app-1778719327051.png" },
    ],
